...
/**
 * Created by JPAM on 1/14/18.
 * Custom [FrameLayout] for camera close controls
 */
class CameraCloseView : FrameLayout {
    ...
    * super() This will allow us to inflate with our own layout*/
    ...
    fun init() {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_camera_control_close, this)
