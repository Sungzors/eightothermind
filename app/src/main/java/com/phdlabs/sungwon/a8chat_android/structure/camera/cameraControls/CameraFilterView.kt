...
/**
 * Created by JPAM on 5/15/18.
 * Custom [FrameLayout] for Camera filter
 */
class CameraFilterView : FrameLayout {
...
* super() This will allow us to inflate with our own layout*/
    ...
    fun init() {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_camera_control_filters, this)
