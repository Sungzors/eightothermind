...
class HandsFreeFragment : CameraBaseFragment() {
    ...
    private val TAG = "HandsFreeFragment"
    ...
    companion object {
        ...
        /**
         * Hands Free mode is only supported in portrait mode
         * Default & Inverse orientations could be used for future dev
         * */
         ...
         *
         * Note: Optimized version of [NormalFragment] [chooseOptimalSize] for Kotlin
         *
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@HandsFreeFragment.cameraDevice = cameraDevice
            startPreview()
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@HandsFreeFragment.cameraDevice = null
        }
    ...
    /**
     * [startVideoRecording]
     * Accessed through Camera Activity to start video recording
    ...
    private fun requestVideoPermissions() {
        //TODO: Remove permissions Rationale
            ...
            if (grantResults.size == VIDEO_PERMISSIONS.size) {
                for (result in grantResults) {
                    if (result != PERMISSION_GRANTED) {
                        ErrorDialog.newInstance(getString(R.string.camera_permission_request))
    ...
    private fun hasPermissionsGranted(permissions: Array<String>) =
            permissions.none {
                checkSelfPermission((context!!), it) != PERMISSION_GRANTED //FIXME: Test context
            }
